...
def run_one(seed, lr=LEARNING_RATE, epochs=EPOCHS, align_at=ALIGN_AT):
    ...
    B = rng.normal(0.375, np.sqrt(1/(HIDDEN_DIM+1)), size=(OUTPUT_DIM, HIDDEN_DIM))
...
def main():
    ...
    plt.title(f"Success vs alignment (Vary B, vary W, {ALIGN_AT})")
